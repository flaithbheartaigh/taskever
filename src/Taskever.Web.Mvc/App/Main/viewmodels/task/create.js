define(['durandal/app', "jquery", "knockout", 'plugins/dialog', 'service!taskever/task', 'service!taskever/friendship', 'session'],
    function (app, $, ko, dialogs, taskService, friendshipService, session) {
        return function () {
            var that = this;
